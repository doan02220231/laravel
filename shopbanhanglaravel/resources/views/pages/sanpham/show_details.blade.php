					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						...
						<div class="tab-content">
							...
							<div class="tab-pane fade" id="reviews" >
								<div class="col-sm-12">
									<ul>
										<li><a href=""><i class="fa fa-user"></i>MAI VĂN ĐOÀN</a></li>
										<li><a href=""><i class="fa fa-clock-o"></i>20CT1/a></li>
										<li><a href=""><i class="fa fa-calendar-o"></i>2051220033</a></li>
									</ul>
									<p>BÀI TẬP BÁO CÁO MÔN CÔNG NGHỆ PHẦN MỀM - MAI VĂN ĐOÀN - 20CT1 - Framework Laravel</p>
									<p><b>BÀI TẬP BÁO CÁO MÔN CÔNG NGHỆ PHẦN MỀM</b></p>
