                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand-product')}}">Tất cả hãng sản phẩm</a></li>
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>Cần gì hãy kick vào link để được giải đáp: <a target="_blank" href="https://www.facebook.com/">Trung tâm hỗ trợ !!</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
